...
public class FibonacciInitializer implements Initializer {
    ...
    public void initialize(int[] array) {
        ...
        */
         ...
         */
        /*  (Проверка№2 ЛР№3)
            - Я могу передать в метод массив arr[0], и при обращении к элементу 
            array[1] возникнет ошибка выполнения!
            - Комментарии надо только к поля класса и методам, кратко и ясно, а описывать
            что ты делаешь внутри метода не надо!
        */
    }
}
